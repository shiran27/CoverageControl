function Point2(x,y) {
	...
	this.detectionProbabilityWRTParticles = function(setOfParticles){

        var jointMissProbability = 1;
        var val = 0;
        for (var i = 0; i < setOfParticles.length; i++){
        	
        	val2 = setOfParticles[i].sensingModelFunction2(this);
        	if(val2>val){
        		val = val2;
        	}
        	////jointMissProbability = jointMissProbability*(1-setOfParticles[i].sensingModelFunction2(this));
        }
        return val;
